...
namespace ryu::ide::text_editor {
    ...
    void editor_view::initialize(int rows, int columns) {
        ...
        _command_line = new core::textbox(context(), this, ids::command_line, "command-line");
        ...
        _caret = new core::caret(context(), this, ids::caret, "editor-caret");
        _caret->font(font());
        ...
        _document = new core::document(rows, columns, _page_width, _page_height);
        _document->clear();
